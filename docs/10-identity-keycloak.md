...
| `espocrm` | EspoCRM (apps), native OIDC | Confidential | copied from EspoCRM's own Administration -> Authentication -> OIDC screen, not guessed | EspoCRM Administration UI, not a repo `.env` |
